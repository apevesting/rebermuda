        ...
        <Container md>
            <div className="flex justify-center my-20">
                <div className="grid grid-cols-1 auto-rows-auto gap-16">
                    ...
                    <div className="md:h-80 items-center grid grid-cols-1 auto-rows-auto md:grid-cols-2 md:grid-rows-1 gap-8">
                        ...
                        <img src="/professional-service.jpeg" alt="Dedicated Professional Service" className="h-full w-full"/>
                    </div>
                    {/* RESULTS ORIENTED */}
                    <div className="md:h-80 items-center grid grid-cols-1 auto-rows-auto md:grid-cols-2 md:grid-rows-1 gap-8">
                        <div className="flex-col">
                        ...
                        <img src="/results-oriented.jpeg" alt="Results Oriented" className="h-full w-full"/>
                    </div>
                    {/* EMBRACE CHANGE */}
                    <div className="md:h-80 items-center grid grid-cols-1 auto-rows-auto md:grid-cols-2 md:grid-rows-1 gap-8">
                        <div className="flex-col">
                        ...
                        <img src="/change.jpeg" alt="Embrace Change & Drive Innovation" className="h-full w-full"/>
                    </div>
                    {/* QUALITY WORK */}
                    <div className="md:h-80 items-center grid grid-cols-1 auto-rows-auto md:grid-cols-2 md:grid-rows-1 gap-8">
                        <div className="flex-col">
                        ...
                        <img src="/quality.jpeg" alt="Pride through Quality Work" className="h-full w-full"/>
                    </div>
                     {/* PASSIONATE */}
                     <div className="md:h-80 items-center grid grid-cols-1 auto-rows-auto md:grid-cols-2 md:grid-rows-1 gap-8">
                        <div className="flex-col">
                        ...
                        <img src="/passion.jpeg" alt="Passionate & Determined" className="h-full w-full"/>
                    </div>
                </div>
            </div>
        </Container>
